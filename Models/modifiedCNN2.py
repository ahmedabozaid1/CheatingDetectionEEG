...
model.add(Dropout(0.2))
model.add(Dense(1, activation='sigmoid'))  # changed softmax to sigmoid
model.summary()
...
#tensorboard_callback = keras.callbacks.TensorBoard(log_dir="./log/MODFCNN")

modelHistory = model.fit(x_train, y_train, epochs=400,
              batch_size=256, validation_data=(X_test, y_test))
score, acc = model.evaluate(X_test, y_test)
#dumb(history)
plot_model(model, to_file='modF_CNN_plot.png',
